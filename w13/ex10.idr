...
zero_plus_right {m = Z} {n = n} = Z_leq
zero_plus_right {m = (S k)} {n = Z} = ?test
zero_plus_right {m = (S k)} {n = (S j)} = S_leq zero_plus_right


zero_plus_left  :  LEQ (0 + n) (m + n)
zero_plus_left {n = Z} = Z_leq
zero_plus_left {n = (S k)} {m = Z} = ?owo
zero_plus_left {n = (S k)} {m = (S j)} = ?wtfcomeshere


-- Task 5
plus_mono_right : LEQ n0 n1 -> LEQ (m + n0) (m + n1)
plus_mono_right Z_leq = zero_plus_right
plus_mono_right (S_leq x) = ?hello
